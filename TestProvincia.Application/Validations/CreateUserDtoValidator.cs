...
namespace TestProvincia.Application.Validations
{
    public class CreateUserDtoValidator : AbstractValidator<CreateUserDto>
    {
        public CreateUserDtoValidator()
        {
            ...
            RuleFor(u => u.DocumentType).NotEmpty().WithMessage(Messages.Error.EmptyField).Must( x => Enum.IsDefined(typeof(DocumentTypeEnum), x)).WithMessage(Messages.Error.InvalidDocumentType);
